	...
	\begin{itemize}
		\item La crittografia è in continuo studio ed evoluzione: ciò che oggi è considerato sicuro domani potrebbe non esserlo.
			\begin{itemize}
				...
				%\item I problemi della fattorizzazione e del calcolo del logaritmo discreto ad oggi non conoscono algoritmi polinomiali, ma in futuro magari esisteranno.
...
%togliere tre alg fattorizzazione
% mettere solo una conclusione alla fine?? anzichè conclusione rsa, dh ed ecdh
