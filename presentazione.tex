...
\begin{frame}{RSA: l'esponente pubblico $e$}
	...
	\begin{itemize}
		...
		\item Un bug di un'implementazione di SaltStack imponeva $e = 1$.
...
% togliere attacchi men in the middle e parametri scelti da una lista?
...
% togliere la spiegazione e dire solo che è uguale a quella di DH su campo primo? mah secondo me è utile avercela anche se poi la skippo
